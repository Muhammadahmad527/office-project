const Setup = () => {
  return (
    <div className="px-6 md:px-12 lg:px-[70px]">
      <section className="text-gray-600 body-font">
        ...
        {/* Wrapper */}
        <div className="container mx-auto flex flex-col lg:flex-row lg:flex-wrap items-center lg:items-start px-4 lg:px-5 py-12 lg:py-24 gap-12">
          {/* Left side steps */}
          <div className="w-full lg:w-2/5 md:w-1/2 md:pr-10 md:py-6 lg:ml-8">
            {/* Step 1 */}
          ...
          {/* Right-side video */}
          <div className="w-full lg:w-2/5 flex justify-center lg:justify-end lg:ml-23">
            <video
              className="lg:w-[400px] md:w-[400px] w-[300px] lg:h-[600px] md:h-[300px] h-[220px] object-cover object-center rounded-lg"
              src="/pizza.mp4"
              controls
              autoPlay
              loop
